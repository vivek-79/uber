...
function SelectedVehicle({setConfirmedVehicle,setVehicleFound}) {
    return (
        <div>
            <h5 onClick={()=>{setConfirmedVehicle(false)}} className='p-1 text-center top-0'><i className="ri-arrow-down-wide-line"></i></h5>
            ...
            <div className='flex gap-2 justify-between items-center flex-col'>
                ...
                <button onClick={()=>{setVehicleFound(true),setConfirmedVehicle(false)}} className='mt-3 w-full bg-green-600 text-white  font-semibold p-2 rounded-lg'>Confirm</button>
            </div>
        </div>
    )
}
